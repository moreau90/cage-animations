import type { Vec3, Quat, Mat3 } from '../types/index.js';
import { vcross, vlen, vnorm } from './vec3.js';
...
export function quat_conjugate(q: Quat): Quat {
...
export function swingTwistDecompose(qDelta: Quat, twistAxis: Vec3): number {
...
export function quat_rotate_vec(q: Quat, v: Vec3): Vec3 {
...
export function shortest_arc_quat(a: Vec3, b: Vec3): Quat {
...
export function extractQuatTwist(restQ: Quat, curQ: Quat, boneDir: Vec3): number {
...
export function mat3_to_quat(M: Mat3): Quat {
...
export function quat_to_mat3(q: Quat): Float64Array {
